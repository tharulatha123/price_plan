    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="user.php"></a>User</li>
                ...
                <tbody>
                  ...
                  if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <td> <a href="edit-user.php?editid=' . $id . '"><button class="btn btn-primary"><i class="ri-edit-2-fill"></i></button></a> 
                      <a href="delete-user.php?deleteid=' . $id . '"><button class="btn btn-danger"><i class="ri-delete-bin-6-line"></i></button></a> </td>
                    </tr>';
                    }
